 ...
 *
 *  pe.h -- Microsoft Portable Executable File header for XNLDR
 * /PROJECT - XNLDR 1.0
...
/**
 * LoadExec -- loads any PE Executable or DLL file to memory
 *
 * @param Filename -- Full path file name to load
 */
extern "C" void LoadExec(CHAR16* Filename);

/**
 * Returns the stack size from the Kernel
 */
extern "C" size_t GetStackSize();

/**
 * Returns the Entry Point Address from the Extracted Executable file
 */
extern "C" KernelEntry GetEntryPoint();

/**
 * If any DLL file is loaded to memory extract and search
 * text symbol for any given Procedure 
 *
 * @param Image -- Buffer address where DLL file was loaded
 * @param Procname -- Procedure Name
 *
 */
extern "C" void* GetProcAddress(void *Image, const char* Procname);

/**
 * returns the Stack Address
 */
extern "C" void* GetStackAddress ();
//=====================================================================
